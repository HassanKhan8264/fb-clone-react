...
function Exam({ mode, posts }) {
  return (
    <div className="main">
        <RightSide mode={`${mode ? "darkpost" : "Litpost"}`} />
        ...
        <div className="leftSideMain">
          ...
          <div className="linkMain">
            <Link to="/components/profile">
              <div
                className="linkIcon profileIcon"
                data-toggle="tooltip"
                data-placement="right"
                title="Profile"
              >
          ...
          <Route
            ...
            element={
              <Videos
                ...
                name={"Hassan Khan"}
                postImage={
                  "https://www.drift.com/wp-content/uploads/2022/03/Build-Trust-With-Every-Conversation-1-1.png"
                }
              />
            }
          />
          <Route
            ...
            element={
              <Profile
                ...
                name={"Hassan Khan"}
                postImage={
                  "https://scontent.fkhi22-1.fna.fbcdn.net/v/t1.6435-9/123247705_393471168504652_3910947716460889517_n.jpg?_nc_cat=102&ccb=1-7&_nc_sid=174925&_nc_eui2=AeE86gIOHOYo9bZByKAx2kkU44d3HhU54q3jh3ceFTnirSa4DC8q9UC3gQ6qxBGf9gMOAdmowIHm8ju-WZDO0oDS&_nc_ohc=jCmMcVt3Nm4AX8Lri57&_nc_ht=scontent.fkhi22-1.fna&oh=00_AT9rgSk-j72r1CPfPelM5aJ5rPm-isAvEvl0-R3rcy4egQ&oe=637B9532"
                }
              />
            }
          />
          <Route
            ...
            element={
              <Menu
                ...
                name={"Hassan Khan"}
                postImage={
                  "https://blog.hootsuite.com/wp-content/uploads/2022/08/facebook-marketing-1.png"
                }
              />
            }
          />
